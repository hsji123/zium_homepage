      ...
      conflict.ajax({
        ...
        success : function(data){
          ...
          conflict("#menu_scroll tr td").click(function(){
            ...
            if(conflict(this).attr("style") == "background-color: rgb(253, 126, 19);"){
              conflict(this).css('background-color','#3A3E39');
              conflict('input:checkbox[name="menu_name"]',this).attr("checked",false);
            }
            else{
...
<body>
	<div id="head_line" style= "padding:24px 0px 8px 0">드신 메뉴를 선택해주세요</div>
